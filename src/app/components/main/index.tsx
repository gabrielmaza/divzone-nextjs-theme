        ...
        >
            ...
            >
                ...
                <div className="relative flex basis-3/5 justify-center z-10 md:ml-40 md:mt-16 md:justify-items-end h-[280px] xs:h-[410px]">
                    <Image src={HomePageGraphic} alt="Home page graphic" className='absolute right-1/2 translate-x-[50%] md:right-0 md:translate-x-0 top-10 md:top-0 h-full md:h-[460px] w-auto object-contain' />
                </div>
            </motion.div>
            {/* HOW DO WE DO IT? */}
