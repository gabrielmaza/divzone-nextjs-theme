...
const Plan = ({
    ...
    return (
        <div className="w-full sm:w-1/3 mb-6 px-[0.125rem]">
            <div className={`hover-up-5 border border-gray-200 pt-16 pb-8 px-4 text-center bg-gray-800 rounded-lg ${recomm && "bg-gray-950"}`}>
                <h3 className="mb-2 text-zxl sm:text-3xl md:text-4xl font-bold font-heading">{name}</h3>
                <span className={`text-4xl font-bold font-heading ${recomm ? "text-primary-100" : "text-secondary-100"}`}>
                    {price}
                </span>
                ...
                <div className='w-fit flex gap-2 flex-col lg:flex-row mx-auto'>
                    <a
                        className={`block py-4 px-6 text-xs text-white text-center font-semibold leading-none rounded transition-all ${recomm ? "bg-primary-300 hover:bg-primary-500" : "bg-transparent hover:bg-gray-950"}`}
                        href="#"
                    >
                        Start Free Trial
                    </a>
